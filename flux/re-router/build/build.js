...
/***/ function(module, exports, __webpack_require__) {
	...
	var Books = React.createClass({displayName: "Books",
	    ...
	    render: function() {
	        ...
	        return id ? React.createElement(Book, {id: id}) : (
	            React.createElement("div", null, 
	                React.createElement("ul", null, 
	                    React.createElement("li", {key: 1}, React.createElement(Link, {to: "books", params: {id: 1}}, "活着")), 
	                    React.createElement("li", {key: 2}, React.createElement(Link, {to: "books", params: {id: 2}}, "挪威的森林")), 
	                    React.createElement("li", {key: 3}, React.createElement(Link, {to: "books", params: {id: 3}}, "从你的全世界走过"))
	                ), 
	    ...
	    render: function() {
	        return (
	            React.createElement("article", null, 
	                React.createElement("h1", null, "这里是图书 id 为 ", this.props.id, " 的详情介绍")
	            )
	        );
	    }
	});
	...
	var Movies = React.createClass({displayName: "Movies",
	    ...
	    render: function() {
	        var id = this.getParams().id;
	        return id ? React.createElement(Movie, {id: id}) : (
	            React.createElement("div", null, 
	                React.createElement("ul", null, 
	                    React.createElement("li", {key: 1}, React.createElement(Link, {to: "movies", params: {id: 1}}, "煎饼侠")), 
	                    React.createElement("li", {key: 2}, React.createElement(Link, {to: "movies", params: {id: 2}}, "捉妖记")), 
	                    React.createElement("li", {key: 3}, React.createElement(Link, {to: "movies", params: {id: 3}}, "西游记之大圣归来"))
	                ), 
	                React.createElement(RouteHandler, null)
	            )
	        );
	...
	var Movie = React.createClass({displayName: "Movie",
	    render: function() {
	        return (
	            React.createElement("article", null, 
	                React.createElement("h1", null, "这里是电影 id 为 ", this.props.id, " 的详情介绍")
	            )
	        );
	    }
	});
	...
	var routes = (
	    React.createElement(Route, {handler: App}, 
	        React.createElement(Route, {name: "movies", path: "/movies/:id?", handler: Movies}), 
	        React.createElement(Route, {name: "books", path: "/books/:id?", handler: Books}), 
