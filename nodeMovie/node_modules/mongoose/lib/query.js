...
/**
 * Specifies which document fields to includes or exclude (also known as the query "projection")
 *
 ...
 * ####Example
 *
 *     // includes a and b, exclude other fields
 *     query.select('a b');
 *
 *     // exclude c and d, includes other fields
 *     query.select('-c -d');
 *
 ...
 *     nearest              All operations read from among the nearest candidates, but unlike other modes, this option will includes both the primary and all secondaries in the random selection.
 *
 * Aliases
 *
 *     p   primary
